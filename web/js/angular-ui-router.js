...
// issue #2676
    ...
    var TransitionHook = (function () {
        function TransitionHook(transition, stateContext, registeredHook, options) {
            ...
            this.stateService = function () {
                return _this.transition.router.stateService;
            };
 ...
 * }
    ...
    function unwrapShorthand(cfg) {
        ...
        return extend(cfg, {
            $$fn: isInjectable(cfg.value) ? cfg.value : function () {
                    return cfg.value;
                }
        });
    }
    ...
    var Param = (function () {
        ...
        Param.values = function (params, values$$1) {
            ...
            return params.map(function (param) {
                return [param.id, param.value(values$$1[param.id])];
            }).reduce(applyPairs, {});
        };
        /**
...
// TODO: explicitly make this user configurable
    ...
    var ResolveContext = (function () {
        ...
        ResolveContext.prototype.subContext = function (state) {
            return new ResolveContext(PathFactory.subPath(this._path, function (node) {
     ...
     * });
        ...
        UrlMatcher.compare = function (a, b) {
            ...
            // console.table(pairs);
            return pairs$$1.reduce(function (cmp, weightPair) {
                return cmp !== 0 ? cmp : weightPair[0] - weightPair[1];
            }, 0);
        };
        return UrlMatcher;
    }());
        ...
        StateMatcher.prototype.find = function (stateOrName, base) {
            ...
            if (state && (isStr || (!isStr && (state === stateOrName || state.self === stateOrName)))) {
                ...
                var matches = values(this._states)
                    .filter(function (state) {
                        return new Glob(state.name).matches(name);
                    });
                if (matches.length > 1) {
 ...
 * }
    ...
    var Transition = (function () {
        ...
        Transition.prototype.applyRootResolvables = function (router) {
            var _this = this;
            var rootResolvables = [
                new Resolvable(UIRouter, function () {
                    return router;
                }, [], undefined, router),
                new Resolvable(Transition, function () {
                    return _this;
                }, [], undefined, this),
                new Resolvable('$transition$', function () {
                    return _this;
                }, [], undefined, this),
                new Resolvable('$stateParams', function () {
                    return _this.params();
     ...
     * });
        ...
        Transition.prototype.injector = function (state, pathName) {
            ...
            if (state)
                path = PathFactory.subPath(path, function (node) {
    ...
    var stringifyPattern = function (value) {
        ...
        stringifyPatternFn = stringifyPatternFn || pattern([
                ...
                [isTransitionRejectionPromise, function (x) {
